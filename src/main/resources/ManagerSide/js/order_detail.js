$("#accpect").click(function (){
    $.ajax({
        url:"http://42.192.224.113:8080/ptj/order/"+$("#order_id").text()+"/"+$("#nuo").val(),// 发送请求的URL字符串。
...
var info;
$("#accpect").ready(function (){
    $.ajax({
        url:"http://42.192.224.113:8080/ptj/job/all",// 发送请求的URL字符串。
        type : "get", //  请求方式 POST或GET
        dataType : "json", // 预期服务器返回的数据类型。
        async:  true , // 默认设置下，所有请求均为异步请求。如果设置为false，则发送同步请求
        // 请求成功后的回调函数。
